...
It looks like a generally good fit, but there seems to be a large overlap of 
clusters in the most central group of points and cluster 1 has an outlier at
around coord (-1.75, -0.45) which looks like it would be better suited to 
cluster k = 5.
