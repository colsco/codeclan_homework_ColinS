...
The ROC curve suggests that the 2-predictor model is very marginally better than
...
An overall accuracy of 80% is the same as the training set, which suggests minimal
overfitting.
